...
<body>
    ...
    <section class="">
        ...
        @include('flash.flash')
            ...
            <form id="form-submit" method="post" enctype="multipart/form-data" action="{{url('/talent-create-hero-post/'.$find_hero_bg->id)}}">
                @csrf
            <div class="main__container">
                <div class="center__container">

                    <div class="center__container--wrapper center__container--sub-wrapper add__extra--padding">
                        <input placeholder="name" name="name" value="{{$find_hero_bg->hero_txt_1}}" >
                        <input placeholder="name" name="desc" value="{{$find_hero_bg->hero_txt_2}}" >
                        ...
                        <div class="container custom__edit--img-inner add__extra--margin">
                            ...
                            <span>Width - 1366 Height - 375</span>
