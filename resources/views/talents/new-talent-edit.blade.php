...
<body>
    ...
    <section class="">
        ...
        @include('flash.flash')
            ...
            <form id="form-submit" method="post" enctype="multipart/form-data" action="{{url('/talent/update/'.$find_talent->id)}}">
                @csrf
            <div class="main__container">
                <div class="center__container">

                    <div class="center__container--wrapper center__container--sub-wrapper add__extra--padding">
                        <input placeholder="name" name="name" value="{{$find_talent->title}}" >
                        {{-- <input placeholder="title" name="main_title"> --}}
                        <textarea placeholder="adv_desc" name="desc">{{$find_talent->description}}</textarea>
