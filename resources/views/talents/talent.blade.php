...
<style>
    ...
    background: url({{url('storage/'.$talents_hero->hero_image)}});
...
<body>
    ...
    <header class="header header--talents">

        @include('includes.nav-header')
        <div class="hero__img_container">

            <div class="hero__images__slide_inner_container">
                <div class="slide__talents">
                    <!-- <img src="resources/images/talent_hero.jpg" style="display:none" class="slidingImage" alt=""> -->
                </div>
            </div>

        </div>

        <div class="hero__text_talents">
            <!-- <span class="hero_text__first">{{$talents_hero->hero_txt_1}}</span>
           <span class="hero_text__second">&nbsp;{{$talents_hero->hero_txt_2}}</span> -->
        </div>
    ...
    <div class="header__sticky_bar">
        ...
        <div class="header__stick_flex_bar row">
            ...
            <p class="bar_talent_get_in_touch">
                Get in touch: talent@tworeport.com
            </p>
    ...
    <section class="talent__section">

        <div class="row">

            <h2 class="talent__title">
                {{($talents[0]->title) }}
                {{-- Become a team player. Earn a squad number. --}}
            </h2>
            <div class="news-paragraph">
                    <?php echo html_entity_decode($talents[0]->description);?>
            </div>

        </div>


        <script src="resources/js/talent.js"></script>
    ...
    <div class="nav_menu__resp">
        <nav class="resp_menu">
            ...
            <a href="about.html" class="resp_menu__link">
                ...
                About Us</a>
            <a href="patnership.html" class="resp_menu__link resp_menu__link--active resp_menu_drp__js">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
