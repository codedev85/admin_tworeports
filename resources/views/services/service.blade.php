...
<head>
    ...
    <title>Services &ndash; TWOREPORT</title>
</head> --}}
...
<style>
    ...
    background: url({{url('storage/'.$hero->hero_image)}});
 ...
 <!-- na header ends here -->
        ...
        <div class="hero__img_container">
            ...
            <div class="hero__images__slide_inner_container">
                <div class="slide__download slide__services">
                    <!-- <img src="resources/images/solutions_hero.jpg" class="slidingImage" style="display: none;" alt=""> -->
                </div>
            </div>
        ...
        <div class="hero__text_container">
            ...
            <div class="hero__text__content hero__text__content--solution hero__text__content--services">

                <span class="download__underline solution__underline">

                </span>
                <h1 class="header_solution__title header_solution__title--adjusted">
                    {{strtoupper($service[0]->main_title)}}

                </h1>

                <p class="header__hero-solution_text header__hero-solution_text--white">
                <?php echo html_entity_decode(Ucfirst($hero->main_title));?>
    ...
    <!-- <section class="section__features_solution">
        <div class="row">
            <div class="solution__features_container">
                @foreach($service as $serv)
                <div class="solution__features_item">
                    <img src="{{url('storage/'.$serv->service_img)}}" alt="" class="solution__features_img">
                    <div class="solutions__features_content">
                        <h2 class="solutions__features_title">
                            {{Ucfirst($serv->sport_title)}}
                        </h2>
                        <p class="solutions__features__text">
                           {{Ucfirst($serv->sport_description)}}
                        </p>
                    </div>
                </div>
                @endforeach
                {{-- <div class="solution__features_item">
                    ...
                    <img src="resources/images/consumer.svg" alt="" class="solution__features_img">
                    ...
                    <div class="solutions__features_content">
                        ...
                        <p class="solutions__features__text">
                            Generating insights from our community helps create a picture of how consumers and brands
                            interact through sports and entertainment.
                        </p>
                    </div>
                ...
                <div class="solution__features_item">
                    ...
                    <img src="resources/images/entertainment.svg" alt="" class="solution__features_img">
                    ...
                    <div class="solutions__features_content">
                        ...
                        <p class="solutions__features__text">
                            Who is consuming, watching and listening to what, where, how and when are critical elements
                            in understanding the market and behavior.
                        </p>
                    </div>
                ...
                <div class="solution__features_item">
                    ...
                    <img src="resources/images/sponsorship.svg" alt="" class="solution__features_img">
                    ...
                    <div class="solutions__features_content">
                        ...
                        <p class="solutions__features__text">
                            With our SponsorTRACK tool and expert analysis we provide actionable feedback that gives you
                            clarity on route-to-market strategy.
                        </p>
                    </div>
                ...
                <div class="solution__features_item">
                    ...
                    <img src="resources/images/digital-monitoring.svg" alt="" class="solution__features_img">
                    ...
                    <div class="solutions__features_content">
                        ...
                        <p class="solutions__features__text">
                            We track all platforms employing tools and methodologies that provide actionable insights at
                            your fingertips.
                        </p>
                    </div>
...
<div class="row">
    ...
    <div class="solution__features_container">
        ...
        <div class="solution__features_item">
            ...
            <img src="resources/images/sports-measurement.svg" alt="" class="solution__features_img">

            <div class="solutions__features_content">
                <h2 class="solutions__features_title">
                {{Ucfirst($service[0]->sport_title)}}
                </h2>
                <p class="solutions__features__text">
                {{Ucfirst($service[0]->sport_description)}}
                </p>
            </div>
        ...
        <div class="solution__features_item">
            ...
            <div class="solutions__features_content">
                <h2 class="solutions__features_title">
                {{Ucfirst($service[1]->sport_title)}}
                </h2>
                <p class="solutions__features__text">
                {{Ucfirst($service[1]->sport_description)}}
                </p>
            </div>
        ...
        <div class="solution__features_item">
            ...
            <div class="solutions__features_content">
                <h2 class="solutions__features_title">
                {{Ucfirst($service[2]->sport_title)}}
                </h2>
                <p class="solutions__features__text">
                {{Ucfirst($service[2]->sport_description)}}
                </p>
            </div>
        ...
        <div class="solution__features_item">
            ...
            <div class="solutions__features_content">
                <h2 class="solutions__features_title">
                {{Ucfirst($service[3]->sport_title)}}
                </h2>
                <p class="solutions__features__text">
                {{Ucfirst($service[3]->sport_description)}}
                </p>
            </div>
        ...
        <div class="solution__features_item">
            ...
            <div class="solutions__features_content">
                <h2 class="solutions__features_title">
                {{Ucfirst($service[4]->sport_title)}}
                </h2>
                <p class="solutions__features__text">
                {{Ucfirst($service[4]->sport_description)}}
                </p>
            </div>
...
@include('includes.footer')
    ...
    <div class="nav_menu__resp">
        <nav class="resp_menu">
            ...
            <a href="" class="resp_menu__link resp_menu__link--active Subscribe resp_menu_drp__js">
                <?xml version="1.0"?>
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
