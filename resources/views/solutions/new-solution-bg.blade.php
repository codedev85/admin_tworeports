...
<body>
    ...
    <section class="">
        ...
        <div class="center__Container">
            ...
            <form id="form-submit" method="post" enctype="multipart/form-data" action="{{url('/solution-create-hero-post/'.$find_hero_bg->id)}}">
                @csrf
            <div class="main__container">
                <div class="center__container">

                    <div class="center__container--wrapper center__container--sub-wrapper add__extra--padding">
                        <input placeholder="name" name="name" value="{{$find_hero_bg->main_desc}}" >
                        <input type="file"  name="solution_img" >
                        <textarea placeholder="adv_desc" name="desc">{{$find_hero_bg->solution_desc}}</textarea>
