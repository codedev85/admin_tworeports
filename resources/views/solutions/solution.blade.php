...
{{-- <style>
    ...
    background: url(../resources/images/solutions_hero.jpg);
...
<style>
    ...
    background: url({{url('storage/'.$solution_hero->hero_image)}});
/***  **/
    background-position: 85% top;
    background-repeat: no-repeat;
    background-size: cover;
...
<body>
    ...
    <header class="header header--solution">
        ...
        <!-- <nav class="header__navigation header__navigation--other">
  ...
  @include('includes.nav-header')
        ...
        <div class="hero__img_container">
            ...
            <div class="hero__images__slide_inner_container">
                <div class="slide__download slide__solution">
        ...
        <div class="hero__text_container">
            ...
            <div class="hero__text__content hero__text__content--solution">

                <span class="download__underline solution__underline">

                </span>
                <h1 class="header_solution__title">
                        {{strtoupper($solution_hero->main_desc)}}
                </h1>

                <p class="header__hero-solution_text">
                <?php echo html_entity_decode(Ucfirst($solution_hero->solution_desc));?>
        ...
        <div class="row">
            ...
            <div class="solution__features_container">
                ...
                <div class="solution__features_item">
                    ...
                    <img src="resources/images/market__solutions.svg" alt="" class="solution__features_img">

                    <div class="solutions__features_content">
                        <h2 class="solutions__features_title">
                            {{$solutions[0]->sub_title}}
                        </h2>
                        <p class="solutions__features__text">
                        <?php echo html_entity_decode(Ucfirst($solutions[0]->sub_description));?>
                        </p>
                    </div>
                ...
                <div class="solution__features_item">
                    ...
                    <img src="resources/images/native__solutions.svg" alt="" class="solution__features_img">

                    <div class="solutions__features_content">
                        <h2 class="solutions__features_title">
                        {{$solutions[2]->sub_title}}
                        </h2>
                        <p class="solutions__features__text">
                        <?php echo html_entity_decode(Ucfirst($solutions[2]->sub_description));?>
                        </p>
                    </div>
                ...
                <div class="solution__features_item">
                    ...
                    <img src="resources/images/advisory__solutions.svg" alt="" class="solution__features_img">

                    <div class="solutions__features_content">
                        <h2 class="solutions__features_title">
                        {{$solutions[1]->sub_title}}
                        </h2>
                        <p class="solutions__features__text">
                        <?php echo html_entity_decode(Ucfirst($solutions[1]->sub_description));?></p>
                    </div>

                </div>
                <div class="solution__features_item">

                    <img src="resources/images/market_e__solutions.svg" alt="" class="solution__features_img">

                    <div class="solutions__features_content">
                        <h2 class="solutions__features_title">
                        {{$solutions[3]->sub_title}}
                        </h2>
                        <p class="solutions__features__text">
                        <?php echo html_entity_decode(Ucfirst($solutions[3]->sub_description));?> </p>
                    </div>
            ...
            <div class="footer__inner_container">
                <div class="footer__outer_wrapper row">
                    ...
                    <div class="footer__list_container">
                        ...
                        <a href=""
                            class="home__btn btn-contact-trigger home__btn--contact home__btn--footer home__btn--touch">
                            Get in touch
                        </a>
