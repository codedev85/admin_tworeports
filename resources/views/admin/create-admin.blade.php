...
<head>
    ...
    <title>TWOREPORT Create admin</title>
    <style>
        ...
        {{-- @include('flash.flash') --}}
            ...
            <div class="main__container">
                    <div class="center__container">
                      ...
                      <form id="form-submit" method="post" enctype="multipart/form-data" action="{{url('/add/admin/post/')}}">
                @csrf
                                           
                        <input id="name" placeholder="Full Name" type="text" class="form-control @error('name') is-invalid @enderror" name="fname" value="{{ old('name') }}" required autocomplete="name" autofocus>
                        ...
                        <input id="password-confirm" type="password" placeholder="confirm password" name="confirm_password"> -->
                        <select name="role">
