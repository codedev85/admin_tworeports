...
<head>
    ...
    <title>Ranking &ndash; TWOREPORT</title>
</head>
...
<body>
    ...
    <header class="header--ranking">
        ...
        <div class="hero__img_container">
            ...
            <div class="hero__images__slide_inner_container">
                <div class="hero__ranking_img_container">

                    <img src="../resources/images/hero__bg_ranking.jpg" class="ranking__hero_img" alt="">
                    <img src="../resources/images/ranking_small.png" class="ranking__hero_img--640" alt="">
    ...
    <section class="ranking__section">

        <div class="row">

            <p class="ranking__main_text">
                Find out what Nigerians are browsing, watching, listening to, seeing and lots more.
            </p>

            <p class="ranking__sub_text">
                Check out our Top-Ranked list compiled weekly and monthly.
            </p>
    ...
    <section class="rank__table_section">

        <div class="row">

            <div class="ranking__tab-cotainer">

                <div class="ranking__tab ranking__tab--active">

                    <p class="ranking__tab_text">
                        TV
                    </p>
            ...
            <div class="ranking__filter_container">

                <div class="ranking__filter_content">

                    <p class="ranking__select_label">
                        TOP 15 LIST FOR
                    </p>

                    <div class="custom-select">
                        <select>
                            <option value="0">Latest Player Update</option>
                            <option value="1">Latest Player Update</option>
                            <option value="2">Latest Club Update</option>
            ...
            <div class="table__wrapper">
                <table class="ranking__data tv tview">
            ...
            <div class="table__wrapper">
                <table class="ranking__data radio">
            ...
            <div class="table__wrapper">
                <table class="ranking__data music">
...
//                     ?>
                    ...
                    @foreach(json_decode($music_cat->rank_name)[0] as $key => $va)
            ...
            <div class="table__wrapper">
                <table class="ranking__data sports">
            ...
            <div class="table__wrapper">
                <table class="ranking__data movie">
            ...
            <div class="table__wrapper">
                <table class="ranking__data social">
    ...
    <section class="rank__table_section__tab">

        <div class="row">

            <div class="rank__inner_tab_wrapper">
                <div class="rank_inner__tab">

                    <div class="ranking__tab ranking__tab--tab ranking__tab--active">

                        <p class="ranking__tab_text">
                            TV
                        </p>
                        <img src="../resources/images/drop-down-arrow.svg" class="table__drop active" width="16px" alt="">

                    </div>

                </div>
                <div class="ranking__filter_container input_view">
                ...
                <div class="table__wrapper table__show">
                    <table class="ranking__data tv tview">
            ...
            <div class="rank__inner_tab_wrapper">
                <div class="rank_inner__tab">
                    ...
                    <div class="ranking__tab ranking__tab--tab Subscribe">

                        <p class="ranking__tab_text">
                            RADIO
                        </p>

                        <img src="../resources/images/drop-down-arrow.svg" class="table__drop" width="16px" alt="">
            ...
            <div class="rank__inner_tab_wrapper">
                <div class="rank_inner__tab">
                    ...
                    <div class="ranking__tab ranking__tab--tab">
    ...
    <div class="nav_menu__resp">
        <nav class="resp_menu">
            ...
            <a href="our-services.html" class="resp_menu__link resp_menu_drp__js">
                <?xml version="1.0"?>
                <?xml version="1.0"?>
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
            ...
            <a href="solutions.html" class="resp_menu__link  Subscribe resp_menu_drp__js">
                <?xml version="1.0"?>
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
            ...
            <a href="about.html" class="resp_menu__link">
                ...
                About Us</a>
            <a href="talent.html" class="resp_menu__link  resp_menu_drp__js">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
