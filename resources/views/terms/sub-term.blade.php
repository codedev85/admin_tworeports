...
<body>
    ...
    <section class="">
        ...
        <div class="center__Container">
            ...
            <form id="form-submit" method="post" enctype="multipart/form-data" action="{{url('/sub-term-create-post/')}}">
                @csrf
            <div class="main__container">
                <div class="center__container">

                    <div class="center__container--wrapper center__container--sub-wrapper add__extra--padding">
                        <input placeholder="name" name="terms_title"  >
                        <textarea placeholder="adv_desc" name="terms_desc"></textarea>
                    </div>
