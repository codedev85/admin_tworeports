...
<body>
    ...
    <section class="">
        ...
        <div class="center__Container">
            ...
            <form id="form-submit" method="post" enctype="multipart/form-data" action="{{url('/term-hero-post/'.$edit_banne ->id)}}">
                @csrf
            <div class="main__container">
                <div class="center__container">

                    <div class="center__container--wrapper center__container--sub-wrapper add__extra--padding">
                        <input placeholder="name" name="terms_title" value="{{$edit_banne->title}}" >
                        <input type="file" placeholder="name" name="hero_bg" value="{{$edit_banne->title}}" >
                        <div class="container custom__edit--img-inner add__extra--margin">

                            <span>Width - 1366 Height - 700</span>

                            {{-- {{$edit_banne ->hero_img}} --}}
                            <img src="{{ url('storage/'.$edit_banne->hero_img) }}"/>
                        </div>
                    </div>
