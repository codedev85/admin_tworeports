...
<body>
    ...
    <section class="">
        ...
        <div class="center__Container">
            ...
            <form id="form-submit" method="post" enctype="multipart/form-data" action="{{url('/sub-term-update-post/'.$edit_sub_term ->id)}}">
                @csrf
            <div class="main__container">
                <div class="center__container">

                    <div class="center__container--wrapper center__container--sub-wrapper add__extra--padding">
                        <input placeholder="name" name="terms_title" value="{{$edit_sub_term ->terms_title}}" >
                        {{-- <input placeholder="title" name="main_title"> --}}
                        <textarea placeholder="adv_desc" name="terms_desc">{{$edit_sub_term ->terms_desc}}</textarea>
