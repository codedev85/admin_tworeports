...
<body>
    ...
    <section class="">
        ...
        <div class="center__Container">
            ...
            <form id="form-submit" method="post" enctype="multipart/form-data" action="{{url('/term-update-post/'.$edit_term->id)}}">
                @csrf
            <div class="main__container">
                <div class="center__container">

                    <div class="center__container--wrapper center__container--sub-wrapper add__extra--padding">
                         <input placeholder="name" name="title" value="{{$edit_term->title}}" >
                         <input type="file" placeholder="name" name="img" value="{{$edit_term->title}}" >
                        <textarea placeholder="adv_desc" name="desc">{{$edit_term->terms}}</textarea>
                        {{$edit_term->hero_img}}
                    </div>
                </div>
            </div>
