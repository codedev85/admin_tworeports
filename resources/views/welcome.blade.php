...
<style>
    .slide__one {
    background: url(../resources/images/hero_slate.jpg);
}
.slide__two {
    background: url(../resources/images/tru_rep_hero_four.jpg);
}

.slide__three {
    background: url(../resources/images/tru_hero_two.jpg);
}

.slide__four {
    background: url(../resources/images/hero_img_three.jpg);
}
            ...
            <div class="hero__images__slide_inner_container hero__images__slide_index__container">
                ...
                <div class="slide__one index__slider">
                    <div class="hero__text__content">
                        ...
                        <h1 class="header__title--small">Uninterupted fun, Quantifiable returns.
                        </h1>
                ...
                <div class="slide__two index__slider">
                    ...
                    <div class="hero__text__content">
                        ...
                        <h1 class="header__title--small">We go beyond the limits.
                        </h1>
                ...
                <div class="slide__three index__slider">
                    ...
                    <div class="hero__text__content">
                        ...
                        <h1 class="header__title--small">It is a valuable power tool.
                        </h1>
                ...
                <div class="slide__four index__slider">
                    ...
                    <div class="hero__text__content">
                        ...
                        <h1 class="header__title--small">And the processes that lead to <br>the (un)expected outcome.
                        </h1>
                            ...
                            <div class="home__table_inner_details_container">
                                ...
                                <div class="home__table_details">
                                    <div>
                                        ...
                                        <div class="see_more__container">
                                            <a href="" class="home__btn home__btn--stroked home__btn--dark">See More</a>
                                        </div>
