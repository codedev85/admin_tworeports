...
<body>
    ...
    <section class="">
        ...
        <div class="center__Container">
            ...
            <form id="form-submit" method="post" enctype="multipart/form-data" action="{{url('/sub-policy-update-post/'.$edit_sub_policy->id)}}">
                @csrf
            <div class="main__container">
                <div class="center__container">

                    <div class="center__container--wrapper center__container--sub-wrapper add__extra--padding">
                        <input placeholder="name" name="title" value="{{$edit_sub_policy->policy_title}}" >
                        {{-- <input placeholder="title" name="main_title"> --}}
                        <textarea placeholder="adv_desc" name="desc">{{$edit_sub_policy->policy_desc}}</textarea>
