...
<!-- wysisyg -->
   ...
   <script src="http://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.4/summernote.js"></script>
    ...
    <title>TWOREPORT Policy Update</title>
</head>
<body>
<div class="top__bar">
...
{{--
        ...
        <div class="center__Container">
            ...
            <div class="main__container">
              <form action="{{url('/policy-update-post/'.$edit_policy->id)}}" method="post" enctype="multipart/form-data">
                  @csrf
                <div class="center__container" id="czContainer">
                    <div class="center__container--wrapper control-group after-add-more"">
                        <input name="policy_title" placeholder="Policy Title" value="{{$edit_policy->title}}">
                        <textarea name="policy_desc" class="summernote" placeholder="Policy Description">
                                <?php echo html_entity_decode($edit_policy->policies);?>
                        </textarea>
