<section class="footer__section">
    <footer class="footer">
        <div class="footer__inner_container">
            <div class="footer__outer_wrapper row">
                ...
                <div class="footer__list_container">
                    ...
                    <a href="{{url('/about-us/')}}" class="footer__link">
                        Vision
                    </a>
                    <a href="{{url('/about-us/')}}" class="footer__link">
                        Mission
                    ...
                    <a href="{{url('/talents/')}}" class="footer__link">
                        Talent
                    </a>
                </div>
        ...
        <div class="privacy__link-container">
            ...
            <div>
            <a href="{{url('/privacy-policy/')}}" class="privacy__link">
                    Privacy Policy
                </a>
                &nbsp;&nbsp;
            </div>
            ...
            <div>
                ...
                &nbsp;&nbsp;
                <a href="{{url('/terms/')}}" class="privacy__link">
                    Terms of Use
                </a>
            </div>
