        ...
        <div class="center__Container">
            <div class="form__header--list">
                <div class="form__header--list1">
                    ...
                    <!-- <p><a href="{{url('news/create/news_category')}}" class="btn btn-success pull-left">Create News Category</a></p> -->
                
                </div>
                <div class="form__header--list1">
            
                    <p><a href="{{url('news/create/news_category')}}" class="btn btn-success pull-left btn-txt"><button><span class="btn-txt">Create News Category</span></button></a></p>
                
                </div>
            </div>
            <form id="form-submit" action="{{url('/company-news-create-post/')}}" method="post" enctype="multipart/form-data">
                @csrf
              <div class="center__container" id="czContainer">
                  <div class="center__container--wrapper control-group after-add-more"">
                      <input name="news_title" placeholder="Company News Title">
                      ...
                      <br><br>
                      <textarea name="news_desc"  class="summernote" placeholder="Policy Description"></textarea>
