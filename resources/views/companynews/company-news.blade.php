...
<head>
    ...
    <link rel="stylesheet" href="resources/css/styles_2.css">
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>

    <title>Privacy &ndash; TWOREPORT</title>
</head>
...
<body>
    ...
    <header class="header header__about header__height--zero header__privacy">

        <nav class="header__navigation home__header_nav fixed js--fixed">
            ...
            <div class="row header__navigation_inner">
                ...
                <div class="menu__right_items">
                    ...
                    <a href="" class="home__btn header__btn js_modal_trigger__btn--two">
                        Subscribe
                    </a>
        ...
        <div class="hero__img_advisory--bg">

            <div class="hero__images__slide_inner_container hero__remove-space">
                <div class="slide__privacy">
                </div>
            </div>
    ...
    <section class="main__container--privacy">

        <div class="main__container--sub-privacy">

            <div class="main__center--text-container">

                 <p>
                  <?php echo html_entity_decode($main_policy->policies  );?>
                </p>
              @foreach($sub_policies as $policy)
                <div class="privacy__section--link-container">
                    <div>
                        <div class="clicked__object"><img src="resources/images/priv__left-arrow.svg" alt=""
                                class="arrow__toggleable-icon"><span class="text__item">{{$policy->policy_title}}</span>
                        </div>

                        <div class="privacy__section--menu-description">
                            <P class="text__item--description">
                                <?php echo html_entity_decode($policy->policy_desc  );?>
                            </P>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="check_discription_section">
                        <div class="modal__check__outer">
                            ...
                            <div class="modal__check_container">
                                ...
                                <label for="download__policy">By clicking <a href="termsofuse.html" target="_blank"
                                        class="label_red">submit</a>, you agree to the terms of <a href="privacy.html
                        ...
                        <div class="modal__check__outer">
                            ...
                            <div class="modal__check_container">
                                ...
                                <label for="download__deselect"><span class="download__deselect--text">Deselect
                                        All</span></label>
                            </div>
                            <div class="modal__check_container">
                                <input type="checkbox" name="" id="download__consent" class="unchecked">
                                <label for="download__consent">I consent to TWOREPORT storing my submitted information
                                    so they can respond
                                    to my enquiry</label>
                            </div>
                            <div class="modal__check_container">
                                <input type="checkbox" name="" id="download__recieve" class="unchecked1">
                            ...
                            <div class="modal__check_container">
                                <input type="checkbox" name="" id="download__agree" class="unchecked2">
