...
<body>
    ...
    <section>
        ...
        <div class="download__main-content download__row">
            ...
            @if($article_related->article_is_not_free == 0)
            <a href="{{ url('pdfview/'.$article_related->id)}}" class="download_btn js_modal_trigger__btn home__btn">FREE DOWNLOAD</a>
         @elseif(!Auth::guest() )
                      ...
                      <div class="col-md-8 col-md-offset-2">
                          <p>
                              {{-- <div>
                                  ...
                                  &#8358; {{$article_related->price}}
                              </div> --}}
                          </p>
                          <input type="hidden" name="email" value="{{Auth::user()->email}}"> {{-- required --}}
                          <input type="hidden" name="orderID" value="345">
                          <input type="hidden" name="amount" value="{{$article_related->price}}"> {{-- required in kobo --}}
                          <input type="hidden" name="quantity" value="1">
                          <input type="hidden" name="metadata" value="{{ json_encode($array = ['customer_email' => Auth::user()->email,'name'=> Auth::user()->name, 'article_id'=>$article_related->id,'article_title'=>$article_related->title,'articles_category'=> $article_related->downloadarticlecat_id]) }}" > {{-- For other necessary things you want to add to your payload. it is optional though --}}
                          ...
                          &#8358; {{$article_related->price}} Download
                          </button>
                          </p>
                      </div>
                      </div>
        ...
        @endif
         ...
         <!-- //to download article -->
            ...
            <div>
                ...
                <?php echo html_entity_decode(Ucfirst(Purifier::clean( $article_related->description)));?>
                <div>
                    <!-- In a study conducted by <a href="" class="download__text_link">CampsBay Media</a> and TWOREPORT, 28
                    ...
                    <br>
                    <br>
                    <img src="../resources/images/TWOREPOR.png" class="two_image__report" alt=""> The penetration, and
                    ...
                    <a href="#" class="download__text_link">2018 FIFA World Cup<sup class="download_sup">TM</sup>
                    ...
                    <br>
                    <br>
                    <img src="../resources/images/TRIMAGE.png" class="two_image__report" alt=""> “We conducted the research
...
@foreach($related_articles as $r_article)
            <div class="sectional__small_card">
                ...
                <div class="home__sectional__card_content">
                    ...
                    <p>
                    <?php   echo html_entity_decode(Ucfirst(str_limit($r_article->description, $limit = 50, $end = '...' )));?>
                    </p>
                    <a href="{{url('/related/article/'.$r_article->id)}}" class="home__btn home__card_btn">Read</a>
                </div>
            </div>
@endforeach
            <!-- <div class="sectional__small_card">
